  ...
  switch (feature) {
    ...
    case 'video':
      ...
      limitMessage = usage.plan === 'Free' ? 
        ...
        usage.plan === 'Pro' ?
        'Monthly video limit reached (50/month). Upgrade to Business for unlimited videos.' :
    ...
    case 'voice':
      ...
      limitMessage = usage.plan === 'Free' ? 
        ...
        usage.plan === 'Pro' ?
        'Monthly voice limit reached (300 min/month). Upgrade to Business for unlimited voice.' :
